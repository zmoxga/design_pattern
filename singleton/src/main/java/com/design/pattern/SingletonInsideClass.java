 ...
 * 因为 SingletonHolder 类没有被主动使用，只有显示通过调用 getInstance 方法时，才会显示装载 SingletonHolder 类，
 ...
 */
public class SingletonInsideClass {
	private static class SingletonHolder {
		private static SingletonInsideClass instance = new SingletonInsideClass();
	}

	private SingletonInsideClass() {
	}

	public static final SingletonInsideClass getInstance() {
